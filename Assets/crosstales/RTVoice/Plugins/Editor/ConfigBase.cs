    ...
    public abstract class ConfigBase : EditorWindow
    {
        ...
        protected static void showConfiguration()
        {
            scrollPosConfig = EditorGUILayout.BeginScrollView(scrollPosConfig, false, false);
            {
                ...
                Util.Constants.DEBUG = EditorGUILayout.Toggle(new GUIContent("Debug", "Enable or disable debug logs (default: " + Util.Constants.DEFAULT_DEBUG + ")."), Util.Constants.DEBUG);

                Util.Constants.UPDATE_CHECK = EditorGUILayout.BeginToggleGroup(new GUIContent("Update Check", "Enable or disable the update-check (default: " + Util.Constants.DEFAULT_UPDATE_CHECK + ")."), Util.Constants.UPDATE_CHECK);
                EditorGUI.indentLevel++;
                Util.Constants.UPDATE_OPEN_UAS = EditorGUILayout.Toggle(new GUIContent("Open UAS-Site", "Automatically opens the direct link to 'Unity AssetStore' if an update was found (default: " + Util.Constants.DEFAULT_UPDATE_OPEN_UAS + ")."), Util.Constants.UPDATE_OPEN_UAS);
                EditorGUI.indentLevel--;
                ...
                Util.Constants.PREFAB_AUTOLOAD = EditorGUILayout.Toggle(new GUIContent("Prefab Auto-Load", "Enable or disable auto-loading of the prefabs to the scene (default: " + Util.Constants.DEFAULT_PREFAB_AUTOLOAD + ")."), Util.Constants.PREFAB_AUTOLOAD);
                ...
                Util.Constants.AUDIOFILE_AUTOMATIC_DELETE = EditorGUILayout.Toggle(new GUIContent("Audio Auto-Delete", "Enable or disable auto-delete of the generated audio files (default: " + Util.Constants.DEFAULT_AUDIOFILE_AUTOMATIC_DELETE + ")."), Util.Constants.AUDIOFILE_AUTOMATIC_DELETE);

                EditorHelper.SeparatorUI();
                GUILayout.Label("UI Settings", EditorStyles.boldLabel);
                Util.Constants.HIERARCHY_ICON = EditorGUILayout.Toggle(new GUIContent("Show Hierarchy Icon", "Show hierarchy icon (default: " + Util.Constants.DEFAULT_HIERARCHY_ICON + ")."), Util.Constants.HIERARCHY_ICON);

                EditorHelper.SeparatorUI();
                GUILayout.Label("Windows Settings", EditorStyles.boldLabel);
                Util.Constants.ENFORCE_32BIT_WINDOWS = EditorGUILayout.Toggle(new GUIContent("Enforce 32bit Voices", "Enforce 32bit versions of voices under Windows (default: " + Util.Constants.DEFAULT_ENFORCE_32BIT_WINDOWS + ")."), Util.Constants.ENFORCE_32BIT_WINDOWS);
