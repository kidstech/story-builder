    ...
    public static class EditorHelper
    {
        ...
        public static void NoVoicesUI()
        {
            ...
            else
            {
                ...
                if (GUILayout.Button(new GUIContent("Add RTVoice", Icon_Plus, "Add the 'RTVoice'-prefab to the current scene.")))
                {
                    InstantiatePrefab("RTVoice");
                }
            }
        }
        ...
        {
            PrefabUtility.InstantiatePrefab(AssetDatabase.LoadAssetAtPath("Assets" + Util.Constants.PREFAB_PATH + prefabName + ".prefab", typeof(GameObject)));
        }
        ...
        public static bool isProxyInScene
        {
            get
            {
                return GameObject.Find("Proxy") != null;
            }
        }
        ...
        private static Texture2D loadImage(ref Texture2D logo, string fileName)
        {
            ...
            {
#if rtv_ignore_setup
                logo = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets" + Util.Constants.ASSET_PATH + "Icons/" + fileName, typeof(Texture2D));
#else
